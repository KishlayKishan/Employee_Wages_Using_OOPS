...
public class EmployeeWages {
	...
	public EmployeeWages(String company, int wagePerHour, int workingDay, int totalWorkHrs) {
	...
	public static void main(String[] args) {
		...
		EmployeeWages comp1 = new EmployeeWages("COMP1", 40, 22, 140);
		EmployeeWages comp2 = new EmployeeWages("COMP2", 90, 21, 222);
		EmployeeWages comp3 = new EmployeeWages("COMP3", 58, 22, 175);
